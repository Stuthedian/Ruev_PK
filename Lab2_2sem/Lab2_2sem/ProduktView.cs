...
namespace Lab2_2sem
{
    public partial class ProduktView : Form
    {
        DataSet1 dataSet;
        ...
        private void IspolnitelView_Load(object sender, EventArgs e)
        {
            ...
            mainview = new DataView(dataSet.Produkt);
            selectedview = new DataView(dataSet.Produkt);
        ...
        private void MainGridView_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                selectedview.RowFilter = "cod_pr=" + cod;
        ...
        public ProduktView(DataSet1 ds, bool e)
        {
            InitializeComponent();
            dataSet = ds;
            is_error_handling = e;
